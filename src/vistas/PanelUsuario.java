...
public class PanelUsuario extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTablePaises.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "NOMBRE", "APELLIDOS", "NRO DOCUMENTO", "TELÉFONO", "EMAIL", "PASSWORD", "PERMISO"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Double.class, java.lang.Object.class, java.lang.Object.class
            };
    ...
    private void AgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarActionPerformed
        ...
        RegistrarUsuarioAdmin registrarUsuario = new RegistrarUsuarioAdmin();
        registrarUsuario.setVisible(true);
        ControlUsuario controlUsuario = new ControlUsuario(registrarUsuario);
    ...
    private void actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actualizarActionPerformed
     ...
     public void BuscarUsuario(){
        int validacion = 0;
            ...
            if (validacion == 0) {
                int codUsuarioBuscar = Integer.parseInt(txtBuscar.getText());
                Usuario usuario = new Usuario();
                usuario.setIdUsuario(codUsuarioBuscar);
                if (modeloUser.buscarUser(usuario)) {
                    
                    BuscarUsuario buscarUsuario = new BuscarUsuario();
                    
                    buscarUsuario.setVisible(true);
                    buscarUsuario.lbId.setText(String.valueOf(usuario.getIdUsuario()));
                    buscarUsuario.lblNombreUsuario.setText(usuario.getNombreUsuario());
                    buscarUsuario.labelNombre.setText(usuario.getNombre());
                    buscarUsuario.lblApellido.setText(usuario.getApellido());
                    buscarUsuario.lblDocumento.setText(usuario.getIdDocumento());
                    buscarUsuario.lblDireccion.setText(usuario.getDireccion());
                    buscarUsuario.lblEmail.setText(usuario.getEmail());
                    buscarUsuario.lblContraseña.setText(usuario.getPassword());
                    buscarUsuario.lblPermiso.setText(usuario.getNivel_permiso());
                    ControlUsuario controlUsuario = new ControlUsuario(buscarUsuario);
                } else {
                    JOptionPane.showMessageDialog(null, "Usuario no registrado");
                }
            } else {
                JOptionPane.showMessageDialog(null, "Debe ingresar el Id del usuario a buscar");
            }
    }
    void MostrarTabla() {
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                    "SELECT idUsuario,nombreUsuario ,nameUsuario, nameApellido, idDocumento, direccion, email, password, permiso  FROM usuario");
