 ...
 * @author ANDERSON
 */
public class BuscarReservaCliente extends javax.swing.JFrame {

    ReservaDAO modelReserva = new ReservaDAO();

    public BuscarReservaCliente() {
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        buttonEliminar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/icons/Pagar.png"))); // NOI18N
        buttonEliminar1.setBorderPainted(false);
        buttonEliminar1.setContentAreaFilled(false);
        buttonEliminar1.setFocusPainted(false);
        buttonEliminar1.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/icons/Press-Pagar.png"))); // NOI18N
        ...
        buttonEliminar2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/icons/Boton_Eliminar.png"))); // NOI18N
        buttonEliminar2.setBorderPainted(false);
        buttonEliminar2.setContentAreaFilled(false);
        buttonEliminar2.setFocusPainted(false);
        buttonEliminar2.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/icons/BotonPress_Eliminar.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(buttonModificar, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(80, 80, 80)
                .addComponent(buttonEliminar2, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(83, 83, 83))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(72, 72, 72)
                        .addComponent(buttonEliminar2, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGap(72, 72, 72)
    ...
    private void buttonEliminar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEliminar1ActionPerformed
        ...
        int idFactura = modelFac.buscarFacturaReserva(lableCodigo.getText());
        factura.setIdFactura(idFactura);
        modelFac.buscar(factura);
        pagar.txtCodFactura.setText(""+factura.getIdFactura());
        pagar.txtMonto.setText(""+factura.getMoneyPrecioFinal());
    ...
    private void buttonEliminar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEliminar2ActionPerformed
        int idEliminar = Integer.parseInt(lableCodigo.getText());
        ...
        if (modelReserva.eliminar(reserva)) {
            ...
            JOptionPane.showMessageDialog(null, "Primero debe ser eliminada la factura, contactarse con un administrador");
        }
    }//GEN-LAST:event_buttonEliminar2ActionPerformed

    private void buttonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonModificarActionPerformed
        dispose();
        ModificarReservaCliente modificarReserva = new ModificarReservaCliente();
        modificarReserva.lblId.setText(lableCodigo.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarReservaCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarReservaCliente().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JButton buttonEliminar2;
